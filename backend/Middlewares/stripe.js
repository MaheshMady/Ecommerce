...
exports.createCheckoutSession = function (lineitems, orderdetail) {
  let session = stripe.checkout.sessions.create({
    ...
    success_url: "https://ecommerce-alpha-teal.vercel.app/success?session_id={CHECKOUT_SESSION_ID}",
    cancel_url: "https://ecommerce-alpha-teal.vercel.app/failure?session_id={CHECKOUT_SESSION_ID}",
  });
